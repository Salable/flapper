...
export const PACK_DEFAULTS = Object.freeze({
  ...
  // black edge 3% wide, a soft hinge band ~11% tall. Vignette and grunge push
  // the flat procedural fill toward a card that has actually sat on a wall -
  // painted, not printed.
  ...
  // smudge - both were present in code and off/invisible by default.
  hinge: Object.freeze({ fill: '#141414', highlight: 'rgba(255,255,255,0.16)', thickness: 0.11, pin: '#3c3c3e', pinWidth: 0.045, pinHeight: 0.1 }),
  glyph: Object.freeze({
    fill: '#efe9df',
    stroke: null,
    strokeWidth: 0.03,
