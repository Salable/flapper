...
const NOTES: Record<string, string> = {
  ...
  rainbow: 'The same three cards as the drink, quicker and hotter - red, amber, blue, then gone.',
  ...
  sherbet: 'Three pastel cards, gone almost before you catch them. Same rule, not lingered over.',
