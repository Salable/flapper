 ...
 *
 * A note on glyphs. The ring is blank, A-Z, 0-9 and `. , ! ( )` - there is
 * no sprite sheet, so a traveller is spelled out of the characters the board
 * actually has. `(` is a passable open mouth and `O` a passable ghost. A
 * design that wants a real pac-man can already give any single character its
 * own uploaded mark (see a pack's `art`), which is the proper fix and not
...
export const TRAVELLERS = Object.freeze({
  ...
  snake: Object.freeze({
    ...
    actors: Object.freeze([
      Object.freeze({ glyph: 'O', length: 1, lead: 0 }),
  ...
  'pac-man': Object.freeze({
    ...
    actors: Object.freeze([
      ...
      Object.freeze({ glyph: 'O', length: 1, lead: 3 }),
      Object.freeze({ glyph: 'O', length: 1, lead: 5 }),
      Object.freeze({ glyph: 'O', length: 1, lead: 7 }),
    ]),
  }),
});
