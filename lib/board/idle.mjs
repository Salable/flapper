...
const FIDGET_DEFAULTS = Object.freeze({
  ...
  washGlyphs: false,
  /**
   * Wear `cardWash` on the way out but not on the way home.
   *
   * A gesture is three coloured cards and then it is over. Washing the
   * return too shows the same colours again in reverse, which stops reading
   * as a gesture and starts reading as the card spinning.
   */
  washOutboundOnly: false,
  /**
