  ...
  if (pack.tint !== null) {
    ...
    if (typeof tint !== 'object' || Array.isArray(tint)) {
      ...
      for (const key of Object.keys(tint)) {
        if (!['gradient', 'corners', 'mode', 'strength'].includes(key)) {
      ...
      if (tint.corners !== undefined) {
        if (typeof tint.corners !== 'object' || Array.isArray(tint.corners)) {
      ...
      } else if (typeof tint.gradient !== 'object' || Array.isArray(tint.gradient)) {
