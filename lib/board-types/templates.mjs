    ...
    templates: [
      {
        ...
        what: [
          'The Carrow Road tiles - green flaps, yellow glyphs',
          'Post the score as it changes; the board holds it',
          'A wide grid for team sheets',
        ],
        config: { theme: 'carrow-road-green', cardSize: 'small' },
      ...
      },
      {
        ...
        config: { cardSize: 'small', align: 'left' },
        seed: [
          {
            rows: [
              'DEPARTURES',
...
const STARTERS = [
  {
    ...
    params: {},
    /*
     * Dan's call, 2026-09-04: lost the permanent queueCap: 1 pin - a sign
     * used to go on being a sign (locked to one message) even after the
     * template had done its work. It's the same board as a cycle now,
     * seeded with one message rather than capped at one: the type's own
     * default queue size applies (lib/board-types/live/definition.mjs),
     * same as every other live board.
     */
    config: {},
