...
export class Flipboard {
  ...
  draw() {
    ...
    const washCells = Array.isArray(this.opts.cardWashCells)
      ? new Set(this.opts.cardWashCells)
      : null;
    ...
    for (let row = 0; row < rows; row += 1) {
      for (let col = 0; col < cols; col += 1) {
        ...
        const worn = wash && mine && (tile.progress > 0 || washCells !== null) ? wash : undefined;
        /*
