    ...
    config: {
      ...
      inputSchema: z.looseObject({
        ...
        themePack: z
          ...
          .optional()
          .describe(
            'The board’s own look on top of its preset: an object with any of card, hinge, glyph, motion, advanced (Hold, Scroll speed, Landing, Frame gap, Sweep, Sweep shape, Always flip - merged a level deep), states, art, fonts (replaced whole), plus background (the colour around and between the cards), tint (a wash across the grid), flight and flightStrength (colours a tile passes through while moving). The server stores only what differs from the preset; null resets to the preset. Fields, ranges and size limits: get_capabilities → themePack. Read get_theme first.',
          ),
        cardSize: z
