  ...
  draw() {
    ...
    for (let row = 0; row < rows; row += 1) {
      for (let col = 0; col < cols; col += 1) {
        ...
        /*
         * A washed card is worn only while the tile is moving, the same rule
         * flight follows: it is a thing you catch on the way past, and a
         * landed card is always the design's own.
         */
        const worn = wash && tile.progress > 0 ? wash : undefined;
        /*
